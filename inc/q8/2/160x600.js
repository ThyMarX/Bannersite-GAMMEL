...
(lib.Tween18 = function(mode,startPosition,loop) {
	...
	this.shape_11.graphics.f("#FFFFFF").s().p("AmbIgQgjgQABgbIAHghIA2h2QAOgeAYAAIAiALQCGBHCPAAQBXAAA6gyQA4gzAAhQQABhbg/g1QhGg+iJAAIivAAQhEAAAAhQIAAntQAAhLBIAAIJgAAQA9AAAAA7IAAB2QAAA/g9AAImOAAIAADHIAOAAQDVAACFBeQCWBpAADKQAADHiOB1QiHBvjUAAQjLAAilhag");
	this.shape_11.setTransform(42.75,-158.05);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AljHTQhiiTgBjwQAAkhB7jGQCWjwEeAAQB3ABBoAdQAuANgJAxIgbCAQgOAvgpgLQhzgXgeAAQh9AAhDBFQhEBIgSCAQBcg0BrAAQC0AABoBfQBvBkAAC+QAAC/hzCCQh7CKjLAAQj3ABh5i1gAhOAzQg4AWgeAdIAAAYQAAEgCzAAQBJAAArhCQAmg5AAhVQAAiuiVAAQguAAg0ATg");
	this.shape_12.setTransform(-48.15,-159.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AB1JuQgsAAgNgJQgNgLAAgnIAAtnIjuCAQgWANgNAAQgbAAgWgrIgwhjIgHgdQgBgbAlgUIFzjVQAqgXA1AAIBuAAQAyAAgBAwIAARuQABA9hCAAg");
	this.shape_13.setTransform(-143,-159.225);
...
(lib._160x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(8,296,0.6857,0.6857);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(47).to({x:-152},10,cjs.Ease.backIn).wait(100).to({x:-172},0).wait(39).to({x:168},0).to({x:8},12,cjs.Ease.backInOut).wait(107));

	// HJUL
	this.instance_1 = new lib.Tween20("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(80.15,361.1,0.2587,0.2571,0,0,0,0.6,0.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(17).to({_off:false},0).to({y:391.1},10,cjs.Ease.backOut).wait(20).to({startPosition:0},0).to({x:-79.85},10,cjs.Ease.backIn).wait(257).to({startPosition:0},0).wait(1));

	// Layer_1
	this.instance_2 = new lib.Tween4("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(80,186.05,0.2312,0.2312);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(267).to({_off:false},0).to({scaleX:0.6589,scaleY:0.6589,alpha:1},6).wait(28).to({startPosition:0},0).to({scaleX:0.3176,scaleY:0.3176,x:83.05,y:326},8,cjs.Ease.backIn).to({_off:true},5).wait(1));

	// LOGO
	this.instance_3 = new lib.Q8();
	this.instance_3.parent = this;
	this.instance_3.setTransform(80.05,-46.95,0.3544,0.3544,0,0,0,98.9,98.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(212).to({_off:false},0).to({regX:99,regY:98.9,scaleY:0.3543,x:80.1,y:238.1},6).wait(43).to({regX:98.9,regY:98.6,scaleY:0.3544,x:80.05,y:228.1},0).to({regX:99,regY:99,scaleX:0.2278,scaleY:0.2278,x:70.05,y:330.85},8,cjs.Ease.backIn).wait(46));

	// LOGO_copy_copy
	this.instance_4 = new lib.shell();
	this.instance_4.parent = this;
	this.instance_4.setTransform(80,-41.95,0.4051,0.4051,0,0,0,98.8,98.9);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(232).to({_off:false},0).to({regY:99,scaleX:0.3544,scaleY:0.3544,y:75.1},6).wait(23).to({y:65.1},0).to({regY:98.9,scaleX:0.3038,scaleY:0.3038,x:70,y:331.05},8,cjs.Ease.backIn).wait(46));

	// LOGO_copy
	this.instance_5 = new lib.logo_();
	this.instance_5.parent = this;
	this.instance_5.setTransform(80.05,-44.8,0.4051,0.4051,0,0,0,98.9,98.7);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(222).to({_off:false},0).to({scaleX:0.3544,scaleY:0.3544,y:156.15},6).wait(33).to({regY:98.6,y:146.1},0).to({scaleX:0.3038,scaleY:0.3038,x:70.05,y:330.95},8,cjs.Ease.backIn).wait(46));

	// Adgang_til
	this.instance_6 = new lib.Tween15("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(430.05,352.95,0.4736,0.4736);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(131).to({_off:false},0).to({x:80},8,cjs.Ease.sineOut).wait(53).to({x:150},0).to({x:-124.2,y:355.65},7,cjs.Ease.sineIn).to({_off:true},1).wait(115));

	// _65
	this.instance_7 = new lib.Tween18("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(291.05,372,0.4976,0.4976,0,0,0,0.1,0);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(53).to({_off:false},0).to({x:98},8,cjs.Ease.sineInOut).wait(66).to({startPosition:0},0).to({x:-140.8},7,cjs.Ease.sineIn).to({_off:true},1).wait(180));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(315));

	// BG
	this.instance_9 = new lib.bg160x600();
	this.instance_9.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(315));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-256.4,215.2,855.5,384.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg160x600.jpg", id:"bg160x600"},
